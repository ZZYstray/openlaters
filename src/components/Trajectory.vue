        ...
        <el-form label-width="80px">
          ...
          <el-form-item label="轨迹样式">
            <el-radio-group v-model="tool" size="small" @change="setType">
              ...
              <el-radio-button label="MultiLineString">线</el-radio-button>
            </el-radio-group>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    drawEnd(evt) {
      ...
      const handle = {
        ...
        MultiLineString: () => {
          //获取坐标点
          let points = geo.getCoordinates();
          this.MultiLineStringPath = points[0];
        },
      };
    ...
    formatFenceData() {
      const handle = {
        ...
        MultiLineString: () => {
          if (this.MultiLineStringPath.length === 0) {
            this.$message.error(this.$t("lan_map.lan_map_fences.pdrwf"));
            return;
          }
